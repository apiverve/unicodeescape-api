...
//
//     UnicodeEscapeUnescapeData data = Converter.fromJsonString(jsonString);
...
public class Converter {
    ...
    public static UnicodeEscapeUnescapeData fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(UnicodeEscapeUnescapeData obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(UnicodeEscapeUnescapeData.class);
        writer = mapper.writerFor(UnicodeEscapeUnescapeData.class);
    }
...
// UnicodeEscapeUnescapeData.java

...
namespace APIVerve.API.UnicodeEscapeUnescape
{
    ...
    /// <summary>
    /// Client for the UnicodeEscapeUnescape API
    /// </summary>
    public class UnicodeEscapeUnescapeAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/unicodeescape";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "action", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public UnicodeEscapeUnescapeAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UnicodeEscapeUnescapeAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UnicodeEscapeUnescapeAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, UnicodeEscapeUnescapeQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(UnicodeEscapeUnescapeQueryOptions options)
        {
        ...
        public ResponseObj Execute(UnicodeEscapeUnescapeQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(UnicodeEscapeUnescapeQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(UnicodeEscapeUnescapeQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(UnicodeEscapeUnescapeQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(UnicodeEscapeUnescapeQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(UnicodeEscapeUnescapeQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(UnicodeEscapeUnescapeQueryOptions options)
        {

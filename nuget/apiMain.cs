...
{
    /// <summary>
    /// Client for the APIVerve.API.UnicodeEscape/Unescape API
    /// </summary>
    public class UnicodeEscape/UnescapeAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        ...
        public UnicodeEscape/UnescapeAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UnicodeEscape/UnescapeAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UnicodeEscape/UnescapeAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, UnicodeEscape/UnescapeQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        public ResponseObj Execute(UnicodeEscape/UnescapeQueryOptions options = null)
        {
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        public Task<ResponseObj> ExecuteAsync(UnicodeEscape/UnescapeQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(UnicodeEscape/UnescapeQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(UnicodeEscape/UnescapeQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(UnicodeEscape/UnescapeQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(UnicodeEscape/UnescapeQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(UnicodeEscape/UnescapeQueryOptions options)
        {

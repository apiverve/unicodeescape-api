// Package unicodeescape provides a Go client for the Unicode Escape/Unescape API.
//
// For more information, visit: https://apiverve.com/marketplace/unicodeescape?utm_source=go&utm_medium=readme
package unicodeescape
...
// Request contains the parameters for the Unicode Escape/Unescape API.
//
// Parameters:
//   - text (required): string - The text to escape
...
// ResponseData contains the data returned by the Unicode Escape/Unescape API.
type ResponseData struct {
	Action string `json:"action"`
	Original string `json:"original"`
	Escaped string `json:"escaped"`
	CharacterCount int `json:"character_count"`
	UnicodePoints []UnicodePointsItem `json:"unicode_points"`
}

// UnicodePointsItem represents an item in the UnicodePoints array.
type UnicodePointsItem struct {

...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/unicodeescape',
        'Source': 'https://github.com/apiverve/unicodeescape-api',
        'Bug Tracker': 'https://github.com/apiverve/unicodeescape-api/issues'
    },
    classifiers=[

...
class unicodeescapeWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/unicodeescape');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/unicodeescape';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"text":{"type":"string","required":true},"action":{"type":"string","required":false,"default":"escape"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/unicodeescape`);
        }
    }
...
module.exports = unicodeescapeWrapper;

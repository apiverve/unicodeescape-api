# Unicode Escape/Unescape API - Examples

This folder contains example code for using the Unicode Escape/Unescape API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/unicodeescape',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/unicodeescape");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/unicodeescape](https://docs.apiverve.com/ref/unicodeescape)
